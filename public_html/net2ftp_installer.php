...
elseif ($_GET["security_code"] != "gocgcib63s78gzm0l5o1" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_2w0ku";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=gocgcib63s78gzm0l5o1" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="ps03391.esy.es"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="u921452033"></td></tr>
